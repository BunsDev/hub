  ...
  const execute = useCallback(async () => {
    ...
    const executeRegisterChain = async () => {
      try {
        ...
        //console.log("result_registerDomain", result_registerDomain);
        ...
        loopfn(receip_registerDomain, hash_registerDomain, async () => {
          ...
          //console.log("result_setResolver", result_setResolver);
          ...
          loopfn(receip_setResolver, hash_setResolver, async () => {
            ...
            //console.log("result_setContentHash", result_setContentHash);
